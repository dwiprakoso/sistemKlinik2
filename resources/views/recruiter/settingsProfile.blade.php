         ...
         <div class="p-4 m-4 rounded-lg dark:border-gray-700">
            ...
            <div class="grid grid-cols-5 items-center justify-center">
                  <div class="col-span-4 p-8 flex items-center h-12 rounded bg-e73002 dark:bg-gray-800">
                     <h1 class=" text-base font-normal leading-none tracking-tight text-white  dark:text-white">Selamat datang, <br/> <span class="text-xl font-extrabold text-white dark:text-blue-500">Aslam Thariq</span></h1>
                  </div>
         ...
         <form class="p-4 md:p-5 overflow-y-auto flex-grow">
            <div class=" grid gap-4 grid-cols-4">
                ...
                <div class="col-span-2">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama perusahaan/organisasi</label>
                ...
                <div class="col-span-2">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis perusahaan</label>
                    <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Posisi yang dibuka" required="">
                </div>
                <div class="col-span-2 sm:col-span-2">
                    <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lokasi perusahaan</label>

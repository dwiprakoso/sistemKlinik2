...
<div class="sm:ml-80">
<form class="p-4 md:p-5 overflow-y-auto flex-grow" id="formSelectionPath" action="{{ route('dashboard.selectionPathTesting') }}" method="POST">
    @csrf
...
<div class="flex items-center border-t border-gray-200 rounded-b dark:border-gray-600 p-4" >
    <div class="flex">
        ...
        <button class="flex items-center justify-center px-3 h-8 text-sm font-medium text-white bg-positive border border-gray-300 rounded-lg hover:bg-positive-hover" type="submit" form="formSelectionPath">

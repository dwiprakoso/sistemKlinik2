      ...
      <div class="flex sm:ml-80">
         ...
         <div class="w-80 border-r border-gray-200 dark:border-gray-700 h-screen overflow-y-auto bg-white dark:bg-gray-800">
            <div class="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-[#e73002] to-[#fd7d09] text-white">
               ...
               <a href="{{ route('dashboard.kandidat.newMessage') }}" class="p-2 rounded-full bg-white/20 text-white hover:bg-white/30 transition-colors relative group">
            ...
            <div>
               @if(isset($conversations) && count($conversations) > 0)
                  @foreach($conversations as $conversation)
                     ...
                     <a href="{{ route('dashboard.kandidat.showMessage', $conversation['user_id']) }}" 
               ...
               @else
                  <div class="p-4 text-center text-gray-500">
                     ...
                     <a href="{{ route('dashboard.kandidat.newMessage') }}" class="text-[#fd7d09] hover:underline">Mulai percakapan baru</a>
                  </div>
               @endif
            </div>
         </div>
            ...
            @if(isset($activeConversation) || isset($activeUserDetails))
              <!-- Header percakapan -->
               ...
               <div class="border-t border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-800">
                  <form action="{{ route('dashboard.kandidat.sendMessage') }}" method="POST">
                     @csrf
            ...
            @else
               ...
               <div class="flex-1 flex items-center justify-center bg-orange-50 dark:bg-gray-750">
                  <div class="text-center p-8 bg-white rounded-lg shadow-sm max-w-md">
                     ...
                     <a href="{{ route('dashboard.kandidat.newMessage') }}" class="inline-block px-6 py-2.5 bg-gradient-to-r from-[#e73002] to-[#fd7d09] text-white font-medium rounded-lg hover:from-[#d62d00] hover:to-[#ed7407] transition-all duration-200">

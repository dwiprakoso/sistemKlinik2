    ...
    <div class="flex flex-col h-full p-6 bg-white rounded-lg">
        ...
        <div class="grid grid-cols-2 gap-4 my-2">
            ...
            <div class="flex items-center p-2 rounded-lg">
                <div
                    class="inline-flex items-center w-8 h-8 p-1 text-sm font-medium text-center text-white rounded-lg me-2 ">
                    <svg class="w-8 h-8 text-e73002" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    ...
                    <span class="sr-only">Hari</span>
                </div>
                <div>
                    <p class="text-sm font-bold text-gray-500">Hari</p>
                    <p class="text-xs font-semibold text-gray-500">Senin, 30 September 2024</p>
                </div>
            </div>
            <div class="flex items-center p-2 rounded-lg">
                <div
                    class="inline-flex items-center w-8 h-8 p-1 text-sm font-medium text-center text-white rounded-lg me-2 ">
                    <svg class="w-8 h-8 text-e73002" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    </svg>

                    <span class="sr-only">Waktu</span>
                </div>
                <div>
                    <p class="text-sm font-bold text-gray-500">Waktu</p>
                    <p class="text-xs font-semibold text-gray-500">10.00 - 11.00 WIB</p>
                </div>
            </div>
            <div class="flex items-center col-span-2 p-2 rounded-lg">
                <div
                    class="inline-flex items-center w-8 h-8 p-1 text-sm font-medium text-center text-white rounded-lg me-2 ">
                    <svg class="w-8 h-8 text-e73002" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <div>
                    <p class="text-sm font-bold text-gray-500">Lokasi</p>
                    <p class="text-xs font-semibold text-gray-500">Jl. Pahlawan No.10 Semarang, Jawa Tengah</p>
                </div>
            </div>
        </div>
        <form action="{{ route('kandidat.submissionMeetingInvitation') }}" method="POST" enctype="multipart/form-data"
            class="flex flex-col h-full">
            @csrf
            <input hidden type="text" name="path_meeting_invitation_id"
                value="{{ $meetPath->pathMeetingInvitation->id }}">
            <div class="flex-grow mb-4">
                <label for="description" class="block mb-2 font-bold text-gray-700">Alasan</label>
            ...
            <div class="flex items-center justify-end gap-4 mt-auto">
                <button type="reset" class="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-red-700"> Tidak
                    bisa hadir</button>
